...
export const CreateWorkModal = () => {
  ...
  {/*const getLanguageByExtension = (fileName) => {
    ...
    switch (extension) {
      case "js":
        return { language: "javascript", iconType: 'SiJavascript' };
      case "cpp":
        return { language: "cpp", iconType: 'TbBrandCpp' };
      case "py":
        return { language: "python", iconType: 'SiPython' };
      case "java":
        return { language: "java", iconType: 'FaJava' };
      default:
        return { language: "plaintext", iconType: 'FaFile' };
    }
  };*/}
  ...
  const onSubmitModal = (e) => {
    ...
    const {language, fileType, iconType } = folderFeatures.getLanguageByExtension(fileName);

    folderFeatures.createNewWork({
      folderName,
      fileName,
      language,
      fileType,
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      ...
      >
        ...
        <h1 className="mb-1 text-[28px] font-bold">Create New Work</h1>
        <div className="flex justify-between items-center gap-5">
          <p className="text-[19px] font-semibold">Enter Folder Name</p>
          <input
            name="folderName"
            required
