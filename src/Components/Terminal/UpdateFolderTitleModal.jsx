...
export const UpdateFolderTitleModal = () => {
  ...
  const id = modalFeatures.modalPayLoad;
  const name = modalFeatures.folderFileNameLoad;
  ...
  const onSubmitModal = (e) => {
    ...
    folderFeatures.editFolderTitle(folderName, id);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      ...
      >
        ...
        <h1 className="mb-1 text-[28px] font-bold">Edit Folder Name</h1>
